...
class MajorKeyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for ((index) in Database().answers.withIndex()) {
            list.add(KeyItem(Database().answers[index], Database().keys[index]))
        }
    ...
    private fun buttonPressed(buttonPressedNum : Button){
        ...
        if(buttonPressedNum.text.toString().equals(list.get(turn - 1).name, true)) {
            Toast.makeText(this@MajorKeyActivity, "Correct", Toast.LENGTH_SHORT).show()
            ...
            if(turn < list.size){
                ...
                builder.setPositiveButton(android.R.string.yes){
                    ...
                    val i = Intent(this, MajorKeyActivity::class.java )
               ...
               // Toast.makeText(this@MajorKeyActivity, "You finished the game with " + score + " score", Toast.LENGTH_SHORT).show()
                builder.show()
            }
